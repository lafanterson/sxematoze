...
screen say(who, what):
    ...
    window:
        id "window"
        background Frame("gui/dialogue_box.png", 70, 70, 50, 50)
        xalign 0.5
        yalign 0.94
        xsize 1400
        ysize 250
        ...
        if who is not None:
            window:
                ...
                style "namebox"
                if who == "Машa":
                    text who id "who" xoffset -185 yoffset 10 size 55 font "fonts/TraktorMoodFont.otf"
                elif who == "Гид":
                    text who id "who" xoffset -150 yoffset 10 size 55 font "fonts/TraktorMoodFont.otf"
                elif who == "Антивирус":
                    text who id "who" xoffset -220 yoffset 10 size 45 font "fonts/TraktorMoodFont.otf"
                elif who == "Рыбак":
                    text who id "who" xoffset -190 yoffset 10 size 55 font "fonts/TraktorMoodFont.otf"
                elif who == "Официант":
                    text who id "who" xoffset -220 yoffset 15 size 45 font "fonts/TraktorMoodFont.otf"
                elif who == "Охранник":
                    text who id "who" xoffset -220 yoffset 15 size 50 font "fonts/TraktorMoodFont.otf"
                elif who == "Чебуречник":
                    text who id "who" xoffset -235 yoffset 15 size 45 font "fonts/TraktorMoodFont.otf"
                elif who == "Промоутер":
                    text who id "who" xoffset -235 yoffset 15 size 45 font "fonts/TraktorMoodFont.otf"
                elif who == "Мастер":
                    text who id "who" xoffset -200 yoffset 15 size 53 font "fonts/TraktorMoodFont.otf"
                elif who == "Незнакомец":
                    text who id "who" xoffset -232 yoffset 15 size 43 font "fonts/TraktorMoodFont.otf"
                elif who == "Бариста":
                    text who id "who" xoffset -215 yoffset 15 size 53 font "fonts/TraktorMoodFont.otf"
                elif who == "Куратор":
                    text who id "who" xoffset -205 yoffset 15 size 53 font "fonts/TraktorMoodFont.otf"
                elif who == "Борис Евгеньевич":
                    text who id "who" xoffset -233 yoffset 23 size 30 font "fonts/TraktorMoodFont.otf"
                elif who == "...":
                    text who id "who" xoffset -135 yoffset -30 size 100 font "fonts/TraktorMoodFont.otf"
        
        # Текст с учетом padding Frame (70px слева, 70px сверху, 50px справа, 50px снизу)
        # Доступная ширина: 1400 - 70 (left) - 50 (right) = 1280px
        # xpos учитывает левый padding Frame + дополнительный отступ
        text what id "what" xpos 90 yalign 0.65 xsize 1240 size 40 text_align 0.0 layout "tex" line_spacing 2
...
style e is default:
    font "fonts/TraktorMoodFont.otf"
    size 65
    xoffset -1850
    yoffset 10
    color "#FF88DD"  # Цвет текста
    ...
    vbox:
        for i in items:
            textbutton i.caption:
                action i.action
                hover_sound i.kwargs.get("hover_sound", None)
...
style choice_button is default:
    #background Frame("gui/button/gradient_idle.png", 10, 10)
    #hover_background Frame("gui/button/gradient_hover.png", 10, 10)
    background Frame("gui/button/new_choice_idle.png", 20, 20)
    hover_background Frame("gui/button/new_choice_hover.png", 20, 20)
    padding (30, 15)
    xmaximum 1000
    xalign 0.5
    yalign 0.5
...
# Быстрое меню снизу включено по умолчанию - даёт кнопку "Назад" и другую навигацию.
...
screen main_menu():
    ...
    add "gui/overlay/main_menu_frame.png"  # Рамка меню

    imagemap:
        alpha False
        #ground "menu_slideshow"
        # ground раньше указывал на "gui/overlay/main_menu.png" - непрозрачную картинку
        # с иллюстрацией, которая полностью закрывала видео-фон (add gui.main_menu_background
        # выше). main_menu_frame.png - тот же логотип/текст кнопок, но без иллюстрации,
        # с тёмной подложкой под текстом (пробовали свести её в прозрачность - решили
        # вернуть, полоска читаемее поверх видео).
        ground "gui/overlay/main_menu_frame.png"
        idle "gui/overlay/main_menu_frame.png"
        hover "gui/overlay/main_menu_hover.png"
        hotspot (40, 550, 600, 80) action ShowMenu("load")
        hotspot (40, 640, 380, 80) action Start() # новая игра
        hotspot (40, 730, 390, 80) action ShowMenu("load")
        hotspot (40, 830, 360, 80) action ShowMenu("preferences")
        hotspot (40, 935, 240, 80) action Quit(confirm=False)  # Выход
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("“СХЕМАТОЗ” – социальный проект по профилактике цифрового мошенничества.")
...
style page_button_text:
    ...
    color "#ffffff"
    hover_color "#cc88ff"
    outlines [ (1, "#440066", 0, 0) ]

style slot_button:
    properties gui.button_properties("slot_button")
    background Frame("gui/button/idle_background.png", gui.slot_button_borders, tile=gui.button_tile)
    hover_background Frame("gui/button/hover_background.png", gui.slot_button_borders, tile=gui.button_tile)

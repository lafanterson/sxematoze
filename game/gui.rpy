...
# Фон главного меню - видео (video/intro.webm), а не статичная картинка. size= задан
# явно по той же причине, что и для остальных видео в проекте (см. комментарий в
# script.rpy) - без него Ren'Py подгоняет дисплеймбл под нативное разрешение файла
# (тут 4K), а не под экран игры.
define gui.main_menu_background = Movie(play="video/intro.webm", loop=True, size=(config.screen_width, config.screen_height))
...
#define gui.dialogue_xanchor = 0.5
define gui.dialogue_xpos = 0.10
define gui.dialogue_ypos = 0.2
define gui.dialogue_width = 1450
define gui.dialogue_text_xalign = 0.005
...
define gui.nvl_borders = Borders(0, 20, 0, 30)
